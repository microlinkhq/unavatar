var _self =
  ...
  Prism = (function () {
    var o = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      O = (_self.Prism = {
        ...
        util: {
          encode: function (e) {
            return e instanceof s
              ? new s(e.type, O.util.encode(e.content), e.alias)
              : O.util.type(e) === 'Array'
                ? e.map(O.util.encode)
                : e
                  .replace(/&/g, '&amp;')
        ...
        languages: {
          ...
          insertBefore: function (a, e, t, n) {
            ...
            for (var l in r) {
              if (r.hasOwnProperty(l)) {
                if (l == e) { for (var i in t) t.hasOwnProperty(i) && (s[i] = t[i]) }
                s[l] = r[l]
              }
            }
            return (
          ...
          DFS: function (e, t, a, n) {
            for (var r in ((n = n || {}), e)) {
              e.hasOwnProperty(r) &&
                (t.call(e, r, e[r], a || r),
                O.util.type(e[r]) !== 'Object' || n[O.util.objId(e[r])]
                  ? O.util.type(e[r]) !== 'Array' ||
                    n[O.util.objId(e[r])] ||
                    ((n[O.util.objId(e[r])] = !0),
                    O.languages.DFS(e[r], t, r, n))
                  : ((n[O.util.objId(e[r])] = !0),
                  O.languages.DFS(e[r], t, null, n)))
            }
          }
        },
        plugins: {},
        ...
        highlightAllUnder: function (e, t, a) {
          ...
          for (
            var r, i = n.elements || e.querySelectorAll(n.selector), s = 0;
            (r = i[s++]);
        ...
        highlightElement: function (e, t, a) {
          ...
          i &&
            ((n = (i.className.match(o) || [, ''])[1].toLowerCase()),
            (r = O.languages[n])),
          (e.className =
              e.className.replace(o, '').replace(/\s+/g, ' ') +
              ' language-' +
              n),
          e.parentNode &&
              ((i = e.parentNode),
              /pre/i.test(i.nodeName) &&
                (i.className =
                  i.className.replace(o, '').replace(/\s+/g, ' ') +
                  ' language-' +
                  n))
          var s = { element: e, language: n, grammar: r, code: e.textContent }
          if ((O.hooks.run('before-sanity-check', s), !s.code || !s.grammar)) {
            return (
              s.code &&
                (O.hooks.run('before-highlight', s),
                (s.element.textContent = s.code),
                O.hooks.run('after-highlight', s)),
              void O.hooks.run('complete', s)
            )
          }
          if ((O.hooks.run('before-highlight', s), t && _self.Worker)) {
            ...
            (s.highlightedCode = O.highlight(s.code, s.grammar, s.language)),
            O.hooks.run('before-insert', s),
            (s.element.innerHTML = s.highlightedCode),
            a && a.call(e),
            O.hooks.run('after-highlight', s),
        ...
        highlight: function (e, t, a) {
          ...
          return (
            ...
            s.stringify(O.util.encode(n.tokens), n.language)
          )
        },
            ...
            if (a.hasOwnProperty(o) && a[o]) {
              ...
              for (var g = 0; g < u.length; ++g) {
                ...
                if (m && !c.pattern.global) {
                  var b = c.pattern.toString().match(/[imuy]*$/)[0]
                  c.pattern = RegExp(c.pattern.source, b + 'g')
                }
                c = c.pattern || c
                for (var y = n, k = r; y < t.length; k += t[y].length, ++y) {
                  var v = t[y]
                  ...
                  if (!(v instanceof l)) {
                    if (m && y != t.length - 1) {
                      ...
                      for (
                        var P = S.index + (p ? S[1].length : 0),
                          w = S.index + S[0].length,
                          F = y,
                          x = k,
                          A = t.length;
                        F < A && (x < w || (!t[F].type && !t[F - 1].greedy));
                        ++F
                      ) { (x += t[F].length) <= P && (++y, (k = x)) }
                      if (t[y] instanceof l) continue
                      ;(j = F - y), (v = e.slice(k, x)), (S.index -= k)
                    } else {
                      c.lastIndex = 0
                      var S = c.exec(v),
                        j = 1
                    ...
                    if (S) {
                      ...
                      var _ = v.slice(0, P),
                        C = v.slice(w),
                        E = [y, j]
                      _ && (++y, (k += _.length), E.push(_))
                      var N = new l(o, d ? O.tokenize(S, d) : S, f, S, m)
                      if (
                        (E.push(N),
                        C && E.push(C),
                        Array.prototype.splice.apply(t, E),
                        j != 1 && O.matchGrammar(e, t, a, y, k, !0, o),
                        i)
                      ) { break }
                    } else if (i) break
                  }
    ...
    if (
      ((s.stringify = function (t, a, e) {
        if (typeof t === 'string') return t
        if (O.util.type(t) === 'Array') {
          return t
            .map(function (e) {
        ...
        if (t.alias) {
          var r = O.util.type(t.alias) === 'Array' ? t.alias : [t.alias]
            ...
            _self.addEventListener(
              ...
              function (e) {
                var t = JSON.parse(e.data),
                  ...
                  n = t.code,
                  r = t.immediateClose
                _self.postMessage(O.highlight(n, O.languages[a], a)),
                r && _self.close()
              },
              !1
            )),
